  ...
  return (
    <div className="flex justify-between items-center px-14 h-14 bg-[#212121] opacity-95 sticky top-0 z-50">
      <div className="flex gap-8 items-center text-2xl">
        ...
        <Link to="/">
          <div className="flex gap-1 items-center justify-center">
            <BsYoutube className="text-3-xl text-red-600" />
      ...
      <div className="flex items-center justify-center gap-5">
        ...
        >
          <div className="flex bg-transparent items-center h-10 px-4 pr-0 rounded-full input-border">
            <div className="flex gap-4 items-center pr-5">
              <div className="font-light inline-flex gap-2">
                <AiOutlineSearch className="text-[24px]" />
              </div>
              <input
                type="text"
                className="w-96 bg-[#212121] focus:outline-none border-none"
                placeholder="Search"
                value={searchTerm}
            ...
            <button className="h-10 w-16 flex items-center justify-center bg-[#ffffff14] rounded-tr-full rounded-br-full">
              <AiOutlineSearch className="text-[24px]" />
            </button>
          </div>
        </form>
